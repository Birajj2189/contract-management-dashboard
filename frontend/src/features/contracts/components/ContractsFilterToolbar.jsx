 ...
 * Use embedded=true inside the same card shell as Parties (rounded-2xl parent).
 */
const ContractsFilterToolbar = ({
  ...
  const searchRow = (
    <div
      className={cn(
        'flex flex-col gap-4 xl:flex-row xl:items-end xl:gap-6',
        embedded && 'border-b border-border/60 pb-4',
        !embedded &&
          'border-b border-border/60 bg-gradient-to-br from-muted/50 via-muted/25 to-transparent px-4 py-4 sm:px-5 sm:py-5'
      )}
    >
  ...
  const dateRow = (
    <div
      className={cn(
        'flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-end sm:justify-between sm:gap-x-6 sm:gap-y-3',
        !embedded && 'px-4 py-4 sm:px-5 sm:py-4'
      )}
    >
